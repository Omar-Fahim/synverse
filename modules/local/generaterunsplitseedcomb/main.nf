...
process GENERATERUNSPLITSEEDCOMB {
    tag '$bam'
    ...
    tuple val("${task.process}"), val('generaterunsplitseedcomb'), eval("generaterunsplitseedcomb --version"), topic: versions, emit: versions_generaterunsplitseedcomb
