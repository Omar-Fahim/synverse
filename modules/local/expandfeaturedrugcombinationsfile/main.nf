...
process EXPANDFEATUREDRUGCOMBINATIONSFILE {
    ...
    tuple val("${task.process}"), val('expandfeaturedrugcombinationsfile'), eval("expandfeaturedrugcombinationsfile --version"), topic: versions, emit: versions_expandfeaturedrugcombinationsfile
